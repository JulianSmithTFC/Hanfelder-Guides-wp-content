							...
							<div class="meteorite-theme-info-col-12">
								<div class="meteorite-theme-info-card">
									...
									<div class="changelog-content">
										<h3>Version 2.1</h3>
										<p class="release-date">Release Date: 12/10/2018</p>
										<ul>
											<li>Added proper float clearing after post content</li>
											<li>Added word-break for post titles</li>
											<li>Added small width single post option to support Gutenbergs align-wide</li>
											<li>Added Gutenberg editor styles</li>
											<li>Changed theme description</li>
											<li>Changed checkbox/radio button display style</li>
											<li>Changed list (ul, ol) appearance</li>
											<li>Changed gallery post format image max-width from 850 to 1140</li>
											<li>Changed Google fonts handling</li>
											<li>Changed minor stylings</li>
											<li>Fixed white post details of image posts without a post thumbnail set</li>
											<li>Fixed error in gallery post type if shortcode has no ids</li>
											<li>Removed typo in changelog</li>
											<li>Removed html5shiv for IE9 and lower</li>
											<li>Updated meteorite.pot</li>
										</ul>
										<h3>Version 2.0</h3>
										<p class="release-date">Release Date: 09/24/2018</p>
										<ul>
											<li>Added option for related posts and related projects in the Customizer</li>
											<li>Added fallback for topbar/footer/404 menu if no menu is assigned in the specific location</li>
											<li>Added masonry style for search</li>
											<li>Added footer link to privacy page, if set in the WordPress settings</li>
											<li>Added a notic about the theme derivation in style.css</li>
											<li>Added theme-side breadcrumbs for titlebar</li>
											<li>Added support for post formats: Aside, Audio, Gallery, Image, Link, Quote, Status, Video</li>
											<li>Added right-to-left support</li>
											<li>Added HTML comments in source code for better orientation</li>
											<li>Added image sizes on blog/archives/search page</li>
											<li>Added support for Fade In (Up) One By One for Elementor</li>
											<li>Added theme info page</li>
											<li>Added demo import</li>
											<li>Added admin notice for theme info page</li>
											<li>Changed .hentry to article for masonry layout since not all items in search do have the .hentry class (masonry-init.js)</li>
											<li>Changed theme screenshot to follow recent changes of the WordPress.org requirements</li>
											<li>Changed theme description</li>
											<li>Changed search submit button in searchform.php</li>
											<li>Changed location of custom-editor-style.css. Moved to /inc/admin/css/</li>
											<li>Changed .nav-placeholder to be located directly in HTML code instead of created by JS</li>
											<li>Fixed missing space between classes with masonry blog layout while having blog/archives on full width</li>
											<li>Fixed the header slider not showing on the blog page</li>
											<li>Fixed the header text not showing if the homepage shows the latest posts</li>
											<li>Fixed Terra Slider not autoplaying the first video slide in Google Chrome</li>
											<li>Fixed heading for day/month/year archives that printed doubled h1 tags</li>
											<li>Fixed missing footer widget areas, if the first footer widget area is empty</li>
											<li>Fixed parallax background not being parallax caused by 1.13.1</li>
											<li>Fixed issues with multiple fade-in-(up-)single animations within one row</li>
											<li>Improved content.php and removed unnecessary code</li>
											<li>Improved navigation fallback text if no menu is assigned in the specific location</li>
											<li>Improved diverse smaller styling issues</li>
											<li>Improved php code for better readability and best practices in all files</li>
											<li>Removed option to show full content on search page due to bad results when using a Page Builder</li>
											<li>Removed option for the search layout, it now has the same as the blog/archives</li>
											<li>Removed option for Yoast/WooCoomerce breadcrumbs. Instead added own breadcrumbs (see above)</li>
											<li>Removed image size meteorite-tiny-thumb which was only used in post tab widget (in compainon plugin)</li>
											<li>Updated theme tags</li>
											<li>Updated meteorite.pot</li>
										</ul>

										<h3>Version 1.13.2</h3>
										<p class="release-date">Release Date: 08/03/2018</p>
										<ul>
											<li>Fixed a non-object error within a header image function</li>
										</ul>

										<h3>Version 1.13.1</h3>
										<p class="release-date">Release Date: 07/13/2018</p>
										<ul>
											<li>Fixed background image bug in Chrome</li>
										</ul>

										<h3>Version 1.13</h3>
										<p class="release-date">Release Date: 02/27/2018</p>
										<ul>
											<li>Added support for Elementor and Beaver Builder</li>
											<li>Fixed horizontal scrollbar caused by dropdown menus</li>
											<li>Improved dropdown menu animation</li>
											<li>Renamed Customizer section (Navigation type > Topbar type)</li>
										</ul>

										<h3>Version 1.12.2</h3>
										<p class="release-date">Release Date: 02/06/2018</p>
										<ul>
											<li>Small CSS adjustments (textarea, .label)</li>
										</ul>

										<h3>Version 1.12.1</h3>
										<p class="release-date">Release Date: 01/24/2018</p>
										<ul>
											<li>Fixed an error with the breadcrumbs</li>
										</ul>
									</div>
									<hr>
